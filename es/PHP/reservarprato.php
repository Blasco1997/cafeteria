...
<body>
    ...
    <main>
        <section id="reserva">
            <h1 class="proposta">NUESTRO MENÚ PROPUESTO PARA HOY</h1>
            <div class="menudodia">
                <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>" method="post">
                    <?php
                        ...
                        if(!$conexion) {
                            ...
                            WHERE m.Día = '2023-09-06'";
                            $resultados = $conexion->query($listarpratos);
                            if($resultados->num_rows==0) {
                                echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' style='width: 15%; transform: translate(130px, -3px);' alt='Aviso'/><p>Hoy no hay menú.</p>";
                            } else {
                    ...
                    <div class="horaaelegir">
                        ...
                        <select name="hora" id="hora">
                            <option selected="selected">Seleccione una hora</option>
                            <option>13:00</option>
                            <option>13:15</option>
                            <option>13:30</option>
                            <option>13:45</option>
                        ...
                        <select name="mesa" id="mesa">
                            ...
                            <?php
                                ...
                                if(!$conexion) {
                                    ...
                                    if($resultados->num_rows==0) {
                                        echo "<option>Sentimos informarle que ya no hay mesas disponibles para hacer reservas</option>";
                                    } else {
                                        $row = $resultados->fetch_assoc();
                                        while($row){
                    ...
                    <div id="reservarprato">
                        <button id="reservar">RESERVAR PLATO</button>
                    </div>
                </form>
                ...
                <script>
                    ...
                    reservar.addEventListener("click", function(event){
                        if(prato.checked == false || bebida.value=='Seleccionar bebida' || hora.value == 'Seleccionar hora' || mesa.value == 'Seleccionar mesa') {
                            ...
                            avisos.innerHTML = '<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Por motivos técnicos no se pudo publicar la reserva.';
                ...
                <?php
                     ...
                     if(!$conexion) {
                        ...
                        $numpratosactuais = "SELECT COUNT(pm.Id_Prato_Menu) AS NumPratosActuais FROM pratosmenus AS pm JOIN menus AS m ON pm.Id_Menu=m.Id_Menú WHERE m.Día='2023-09-06'";
                            ...
                            for($i=1; $i<=$totalpratosactuais; $i++){
                                if(isset($_POST["prato$i"]) && isset($_POST["idmenu"]) && isset($_POST["bebida"]) && isset($_POST["hora"]) && isset($_POST["mesa"]) && isset($_SESSION["cliente"])) {
                                    ...
                                    if($resultado->num_rows==0){
                                        ...
                                        if($resultado->num_rows==0){
                                            echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>No existe el producto $bebida.";
                                        } else {
                                            $row = $resultado->fetch_assoc();
                                            ...
                                            if($resultado->num_rows==0){
                                                echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>No existe el menú Nº $idmenu.";
                                            } else {
                                                $row = $resultado->fetch_assoc();
                                                ...
                                                if($resultado->num_rows==0){
                                                    ...
                                                    if($resultado->num_rows==0){
                                                        echo "<img class='advertencia' src='Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>No existe el cliente $cliente.";
                                                    } else {
                                                        $row = $resultado->fetch_assoc();
                                                        ...
                                                        if($conexion->query($publicarreserva)==true){
                                                            ...
                                                            if($conexion->query($mesareservada)==true){
                                                                ...
                                                                if($conexion->query($stockbebidaactualizado)==true){
                                                                    echo "<img class='correcto' src='../Imaxes/Xerais/correcto.png' width='100%' alt='Aviso'/>Reserva del plato $prato para las $hora hecha correctamente.";
                                                                } else if($conexion->query($stockbebidaactualizado)==false){
                                                                    echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>No se pudo actualizar el stock del producto $bebida.";
                                                                }
                                                            } else if($conexion->query($mesareservada)==false){
                                                                echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Por motivos técnicos hubo un error al reservar la mesa.";  
                                                            }
                                                        } else if($conexion->query($publicarreserva)==false){
                                                            echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Por motivos técnicos no se pudo publicar la reserva.";
                                                        }
                                                    }
                                                }
                                            }
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/reservarprato.php">Gallego</a>
            <a class="axuda" href="../../es/PHP/reservarprato.php">Castellano</a>
