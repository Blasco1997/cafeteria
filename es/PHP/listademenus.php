...
<head>
    ...
    <title>BAR MANOLA - Lista de menús</title>
    ...
    <body>
                ...
                <ul>
                    ...
                    <li><a href="#">Consultas</a>
                        <ul>
                            ...
                            <li><a href="listadeempregados.php">Lista de empregados</a></li>
                            <li><a href="listadepratos.php">Lista de pratos</a></li>
                            <li>Lista de menús</li>
        ...
        <main>
            <section class="consulta">
                <h1 class="tituloconsulta">LISTA DE MENÚS:</h1>
                <div class="filtrocategoria"></div>
                <form class="busquedaproduto" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="get">
                    <input type="search" name="buscarmenu" id="buscar" placeholder="&#128269; Buscar menú del día"/>
                ...
                <?php
                    if(isset($_GET["buscarmenu"])){
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                echo "<div class='avisos' style='display: block;'><img src='Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>No existen menús que tengan los números $menu.</div>";
                            } else {
                                if(isset($_GET["pg"])) {
                                    $paginacion = $_GET["pg"];
                                ...
                                echo "<table><tr><th>Fecha</th><th>Precio</th><th>Opciones</th></tr>";
                                while($row && $cont<=12){ 
                    ...
                    if(!$conexion) {
                        ...
                        if($resultados->num_rows==0) {
                            echo "<div class='avisos' style='display: block;'><img src='Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Aún no se rexistro ningún menú.</div>";
                        } else {
                            if(isset($_GET["pg"])) {
                                $paginacion = $_GET["pg"];
                                if($paginacion<=0 || is_numeric($paginacion)==false) $paginacion=1;
        ...
        <footer>
            ...
            <div class="soporte">
                <a class="axuda" href="../../gl/PHP/listademenus.php">Gallego</a>
                <a class="axuda" href="../../es/PHP/listademenus.php">Castellano</a>
