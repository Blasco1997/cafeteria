<?php
    ...
    session_start();
    //include "estilosxeraiscafeteria.php";
...
<head>
    ...
    <body>
        ...
        <main>
            <section class="consulta">
                ...
                <form class="busquedaproduto" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="get">
                    <input type="search" name="buscarreserva" id="buscar" placeholder="&#128269; Buscar reserva por hora, plato o cliente"/>
                                    ...
                                    if($conexion->query($actualizarestadoreserva)==true){
                                        ...
                                        if($resultado->num_rows==0){
                                            ...
                                            if($conexion->query($mesaocupada)==true){
                                                echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/correcto.png' width='100%' alt='Aviso'/>Reserva de la Mesa $idmesa actualizada.</div>";
        ...
        <footer>
            ...
            <div class="soporte">
                <a class="axuda" href="../../gl/PHP/listadereservas.php">Gallego</a>
                <a class="axuda" href="../../es/PHP/listadereservas.php">Castellano</a>
