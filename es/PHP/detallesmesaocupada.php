...
<head>
    ...
    <title>BAR MANOLA - Detalles de mesas ocupadas</title>
    ...
    <body>
        ...
        <main>
            <section class="consulta">
                <h1>DETALLES DE LA MESA OCUPADA:</h1>
                <?php
        ...
        <footer>
            ...
            <div class="soporte">
                <a class="axuda" href="../../gl/PHP/detallesmesaocupada.php">Gallego</a>
                <a class="axuda" href="../../es/PHP/detallesmesaocupada.php">Castellano</a>
