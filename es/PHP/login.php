...
<body>
    <header>
        ...
        <div id="barrasuperior">
            <a id="usuario" href="rexistrarse.php">Registrarse</a>
        </div>
    </header>
    <hr>
    <main>
                    ...
                    if(isset($_GET["usuario"]) && isset($_GET["contrasinal"])){
                        ...
                        if(!$conexion) {
                            ...
                            if($resultado->num_rows==0){
                                echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>No existe el cliente $usuario.";
                            } else {
                                ...
                                if($usuario == $row["Usuario"] && $contrasinal == $row["Contrasinal"]){
                                    ...
                                    if($conexion->query($usuarioactivo)==true) {
                                        ...
                                        echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Por motivos técnicos no se pudo activar tu usuario. Y por lo tanto, no se pudo iniciar la sesión.";
                                    }
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/login.php">Gallego</a>
            <a class="axuda" href="../../es/PHP/login.php">Castellano</a>
