<?php
    ...
    if(!isset($_SESSION["cliente"])){
        ...
        $usuario = '<img style="border-radius: 100%;" src="../Imaxes/Xerais/User.png" width="30" alt="User"/>'.$_SESSION["cliente"].'<span class="material-symbols-outlined" id="morevert">more_vert
            <ul>
                <li><a href="cerrarsesionecliente.php">Cerrar sesión</a></li><br/>
...
<head>
    ...
    <title>BAR MANOLA - Productos a la venta - Bebida</title>
...
<body>
    ...
    <main>
        <section id="produtos">
            ...
            <div class="filtrocategoriaproduto">
                ...
                <button><a href="produtos3.php">Otros</a></button>
            </div>
                    ...
                    if(isset($_GET["buscarproduto"])){
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                ...
                                $paginacion=1;
                                $url="produtos2.php?categoria=Bebida&buscarproducto=$produto&pg=";  
    ...
    <div class="colaboradores">
        ...
        <div class="soporte">
        <a class="axuda" href="../../gl/PHP/produtos2.php">Gallego</a>
            <a class="axuda" href="../../es/PHP/produtos2.php">Castellano</a>
