...
<head>
    ...
    <title>BAR MANOLA - Produtos a la venta - Varios</title>
...
<body>
                    ...
                    if(isset($_GET["buscarproduto"])){
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                ...
                                $paginacion=1;
                                $url="produtos1.php?categoria=Varios&buscarproducto=$produto&pg=";  
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Aún no hay productos disponibles en la categoría Varios.</div>";
                            } else {
                                if(isset($_GET["pg"])) {
                                    $paginacion = $_GET["pg"];
                                    if($paginacion<=0 || is_numeric($paginacion)==false) $paginacion=1;
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/produtos1.php">Gallego</a>
            <a class="axuda" href="../../es/PHP/produtos1.php">Castellano</a>
