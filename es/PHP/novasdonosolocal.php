...
<head>
    ...
    <title>BAR MANOLA - Noticias do nuestro local</title>
...
<body>
    ...
    <main>
        <section id="quensomos">
            <h1>NOTICIAS DE NUESTRO LOCAL</h1>
            <?php
                ...
                if(!$conexion) {
                    ...
                    if($resultados->num_rows==0) {
                        ...
                        while($row && $cont<=9){
                            ...
                            <a href='{$row["Enlace"]}'><h3>{$row["Titulo"]}</h3></a><p>By {$row["Usuario"]} | Fecha de publicación: {$row["DataPublicacion"]}</p></div>
                            </div>";
                            $row = $resultados->fetch_assoc(); 
                            $cont++; 
                        }
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/novasdonosolocal.php">Gallego</a>
            <a class="axuda" href="../../es/PHP/novasdonosolocal.php">Castellano</a>
