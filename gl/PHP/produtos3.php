...
<head>
    ...
    <title>BAR MANOLA - Produtos á venta - Outros</title>
...
<body>
    ...
    <section id="produtos">
            ...
            <div class="filtrocategoriaproduto">
                ...
                <button id='disabled'>Outros</button>
            </div>
                    ...
                    if(isset($_GET["buscarproduto"])){
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                ...
                                $paginacion=1;
                                $url="produtos3.php?categoria=Outros&buscarproduto=$produto&pg=";  
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                echo "<div class='avisos' style='display: block;'><img src='Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Aínda non hai produtos dispoñibles na categoría Outros.</div>";
                            } else {
                                if(isset($_GET["pg"])) {
                                    $paginacion = $_GET["pg"];
                                    if($paginacion<=0 || is_numeric($paginacion)==false) $paginacion=1;
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/produtos3.php">Galego</a>
            <a class="axuda" href="../../es/PHP/produtos3.php">Castelán</a>
