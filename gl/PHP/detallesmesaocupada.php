    ...
    <body>
        ...
        <main>
            <section class="consulta">
                <h1>DETALLES DA MESA OCUPADA:</h1>
                <?php
                            ...
                            if($resultado->num_rows==0){
                                ...
                                if($row["Pagado"] == "Pendente de entrega"){
                                    ...
                                    if($conexion->query($actualizarestadoreserva)==true){
                                        ...
                                        echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Por motivos técnicos, non se pudo actualizar o estado da reserva.</div>";
                                    }
                                    ...
                                    if($resultado->num_rows==0){
                                        ...
                                        if($resultado->num_rows==0){
                                            ...
                                            if($row["Estado"]=="Pagado"){
                                                ...
                                                <td><form action='actualizarestadoreserva.php'>
        ...
        <footer>
            ...
            <div class="soporte">
                <a class="axuda" href="../../gl/PHP/detallesmesaocupada.php">Galego</a>
                <a class="axuda" href="../../es/PHP/detallesmesaocupada.php">Castelán</a>
