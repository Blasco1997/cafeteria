...
<head>
    ...
    <title>BAR MANOLA - Quen somos</title>
...
<body>
    <header>
        ...
        <nav id="navegacion">
            <ul>
                ...
                <li><a href="novasdonosolocal.php">Novas do noso local</a></li>
            </ul>
        </nav>
    </header>
    <hr>
            ...
            <?php
                ...
                if(!$conexion) {
                    ...
                    if($resultados->num_rows==0) {
                        echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non hai empregados ou aínda non se definiron.</div>";
                    } else {
                        ...
                        while($row){
                            if($row["Nome_completo"]=="María Victoria Pazos Rodríguez"){
                                ...
                                <div class='descempregado'><h3>{$row["Nome_completo"]}</h3><p>Xefa, dependenta do local e cociñeira</p></div>
                                </div>";
                                ...
                                <div class='descempregado'><h1>{$row["Nome_completo"]}</h1><p>Empregado</p></div>
                                </div>";
                            }
                            $row = $resultados->fetch_assoc();  
                        }
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/quensomos.php">Galego</a>
            <a class="axuda" href="../../es/PHP/quensomos.php">Castelán</a>
