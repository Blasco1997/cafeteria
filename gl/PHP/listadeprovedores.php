...
<head>
    ...
    <title>BAR MANOLA - Listado de provedores</title>
    ...
    <body>
                ...
                <ul>
                    <li><a href="#">Administración</a>
                        <ul>
                            ...
                            <li><a href="rexistroempregado.php">Engadirdir Empregado</a></li>
        ...
        <main>
            <section class="consulta">
                <h1 class="tituloconsulta">LISTA DE PROVEDORES:</h1>
                <div class="filtrocategoria"></div>
                <form class="busquedaproduto" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="get">
                    <input type="search" name="buscarprovedor" id="buscar" placeholder="&#128269; Buscar provedor"/>
                ...
                <?php
                    ...
                    if(!$conexion) {
                        ...
                        if($resultado->num_rows==0){
                            echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Aínda non hai provedores contratados.</div>";
                        } else {
                                ...
                                isset($_POST["telefono"]) && isset($_POST["paxinaweb"]) && isset($_POST["imaxe"]) && isset($_POST["gardarcambios"])){
                                    ...
                                    if($resultado->num_rows==0){
                                        ...
                                        if($conexion->query($actualizarprovedor)==true){
                                            echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/correcto.png' width='100%' alt='Aviso'/>Datos do provedor actualizados correctamente.</div>";
                                        } else if($conexion->query($actualizarprovedor)==false){
                                            echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Por motivos técnicos non se puido actualizar o provedor $provedor.</div>";
                                        }
                                    }
                                }
                                ...
                                isset($_POST["telefono"]) && isset($_POST["paxinaweb"]) && isset($_POST["imaxe"]) && isset($_POST["despedirprovedor"])){
                                    ...
                                    if($resultado->num_rows==0){
                                        ...
                                        if($conexion->query($despedirprovedor)==true){
                                            echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/correcto.png' width='100%' alt='Aviso'/>Despediuse ao provedor $provedor.</div>";
                                        } else if($conexion->query($despedirprovedor)==false){
                                            echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Por motivos técnicos non se puido dar a orde de despido para o provedor $provedor.</div>";
                                        }
                                    }
                                }
                            }
                ...
                <form id="edicion" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="post">
                    ...
                    <div class="campoproduto">
                        ...
                        <button id="eliminar" name="despedirprovedor">DESPEDIR PROVEDOR</button>
                    </div>
                </form>
                <?php
                    if(isset($_GET["buscarprovedor"])){
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non hai ningún provedor que conteña os caracteres $provedor.</div>";
                            } else {
                                if(isset($_GET["pg"])) {
                                    $paginacion = $_GET["pg"];
                                ...
                                echo "<table><tr><th>Logo</th><th>Provedor</th><th>Dirección</th><th>Teléfono</th><th>Páxina web</th><th>Opcións</th></tr>";
                                while($row && $cont<=12){  
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                ...
                                $paginacion=1;
                                $url="listadeprovedores.php?provedores&pg=";  
                                echo "<p class='pagina'>";
                                if($paginacion>1)
                                    echo "<a href='$url".($paginacion-1)."'>&lt;&lt;Anterior</a>";
                                $total_paginas=(int)($resultados->num_rows/12+1);
        ...
        <footer>
            ...
            <div class="soporte">
                <a class="axuda" href="../../gl/PHP/listadeprovedores.php">Galego</a>
                <a class="axuda" href="../../es/PHP/listadeprovedores.php">Castelán</a>
