...
<head>
    ...
    <title>BAR MANOLA - Engadir nova</title>
...
<body>
                    ...
                    && isset($_POST["data"]) || isset($_POST["imaxe"])) {
                        ...
                        if(!$conexion) {
                            ...
                            if($resultado->num_rows==0){
                                echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non existe o empregado $empregado.";
                            } else {
                                ...
                                if($conexion->query($publicarnova)==true) {
                                    echo "<img class='correcto' src='../Imaxes/Xerais/correcto.png' width='100%' alt='Aviso'/>Nova publicada correctamente.";
                                } else if($conexion->query($publicarnova)==false) {
                                    echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non se puido publicar a nova.";
                                }
                            }
                        }  
                    }
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/engadirnova.php">Galego</a>
            <a class="axuda" href="../../es/PHP/engadirnova.php">Castelán</a>
