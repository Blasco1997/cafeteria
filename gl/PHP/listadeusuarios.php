...
<head>
    ...
    <title>BAR MANOLA - Listado de clientes</title>
    ...
    <body>
        ...
        <main>
            <section class="consulta">
                <h1 class="tituloconsulta">LISTADO DE CLIENTES:</h1>
                    ...
                    if(isset($_GET["buscarcliente"])){
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non existen clientes que teñan os caracteres $cliente.</div>";
                            } else {
                                if(isset($_GET["pg"])) {
                                    $paginacion = $_GET["pg"];
                                ...
                                echo "<table><tr><th>Perfil</th><th>Usuario</th><th>Nome completo</th><th>Teléfono</th><th>Correo</th><th>Estado</th></tr>";
                                while($row && $cont<=12){ 
                        ...
                        if(!$conexion) {
                            ...
                            if($resultados->num_rows==0) {
                                echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Aínda non se rexistraron clientes.</div>";
                            } else {
                                if(isset($_GET["pg"])) {
                                    $paginacion = $_GET["pg"];
                                    if($paginacion<=0 || is_numeric($paginacion)==false) $paginacion=1;
        ...
        <footer>
            ...
            <div class="soporte">
                <select>
                    <option selected="selected">Galego</option>
                    <option id="castelan">Castelán</option>
                </select>
                <script>
                    document.getElementById("castelan").addEventListener("click", function(){
                        window.location.href="../../es/PHP/listadeusuarios.php";
                    });
                </script>
                <a class="axuda" href="../../gl/PHP/listadeusuarios.php">Galego</a>
                <a class="axuda" href="../../es/PHP/listadeusuarios.php">Castelán</a>
