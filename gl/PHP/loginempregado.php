...
<body>
            ...
            <form class="login" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="get">
                <?php
                    if(isset($_GET["usuario"]) && isset($_GET["contrasinal"])){
                        ...
                        if(!$conexion) {
                            echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='20%' alt='Aviso'/>Non se puido conectar á nosa base de datos. Inténteo máis tarde.";
                        } else {
                            ...
                            if($resultado->num_rows==0){
                                echo "<img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non existe o empregado $usuario.";
                            } else {
                ...
                <nav>
                    <ul>
                        ...
                        <li id="linklogindisabled">Empregado</li>
                    </ul>
                </nav>
                <script>
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/loginempregado.php">Galego</a>
            <a class="axuda" href="../../es/PHP/loginempregado.php">Castelán</a>
