...
<head>
    ...
    <body>
                            ...
                            for($j=1; $j<=$totalmesas; $j++){
                                if(isset($_GET["mesa$j"])){
                                    ...
                                    if($resultado->num_rows==0){
                                        ...
                                        if($resultado->num_rows==0){
                                            echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non hai ninguna reserva para a $mesa.</div>";
                                        } else {
                                            $row = $resultado->fetch_assoc();
        ...
        <footer>
            ...
            <div class="soporte">
                <a class="axuda" href="../../gl/PHP/detallesreserva.php">Galego</a>
                <a class="axuda" href="../../es/PHP/detallesreserva.php">Castelán</a>
