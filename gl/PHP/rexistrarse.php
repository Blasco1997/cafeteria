...
<body>
                    ...
                    if(!$conexion) {
                        ...
                        && $repitacontrasinal=="" || $telefono=="" || $correo==""){
                            ...
                            if($conexion->query($rexistro)==true) {
                                echo "<div class='avisos' style='display: block;'><img class='correcto' src='../Imaxes/Xerais/correcto.png' width='100%' alt='Aviso'/>Cliente $novousuario rexistrado correctamente.</div>";
                            } else if($conexion->query($rexistro)==false) {
                                echo "<div class='avisos' style='display: block;'><img class='advertencia' src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Non se puido rexistrar ao cliente $novousuario.</div>";
                            }
                        }
                    }
                }
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/rexistrarse.php">Galego</a>
            <a class="axuda" href="../../es/PHP/rexistrarse.php">Castelán</a>
