...
<head>
    ...
    <title>BAR MANOLA - Produtos á venta - Varios</title>
...
<body>
    ...
    <main>
        <section id="produtos">
            ...
            <div class="filtrocategoriaproduto">
                <button id='disabled'>Varios</button>
                ...
                <?php
                    if(isset($_GET["buscarproduto"])){
                        ...
                        if(!$conexion) {
                            ...
                            $buscarproduto = "SELECT * FROM produtos WHERE Tipo = 'Varios' AND Produto LIKE '%$produto%'";
                            ...
                            if($resultados->num_rows==0) {
                                ...
                                $paginacion=1;
                                $url="produtos1.php?categoria=Varios&buscarproduto=$produto&pg=";  
                        ...
                        if(!$conexion) {
                            ...
                            $listarempregados = "SELECT * FROM produtos WHERE Tipo = 'Varios'";
                            $resultados = $conexion->query($listarempregados);
                            if($resultados->num_rows==0) {
                                echo "<div class='avisos' style='display: block;'><img src='../Imaxes/Xerais/aviso.png' width='100%' alt='Aviso'/>Aínda non hai produtos dispoñibles na categoría Varios.</div>";
                            } else {
                                ...
                                $paginacion=1;
                                $url="produtos1.php?categoria=Varios&pg=";  
                                echo "<p class='paginaproduto'>";
                                if($paginacion>1)
                                    echo "<a href='$url".($paginacion-1)."'>&lt; Anterior</a>";
                                $total_paginas=(int)($resultados->num_rows/12+1);
    ...
    <footer>
        ...
        <div class="soporte">
            <a class="axuda" href="../../gl/PHP/produtos1.php">Galego</a>
            <a class="axuda" href="../../es/PHP/produtos1.php">Castelán</a>
